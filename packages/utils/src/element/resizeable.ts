...
export function resizable(resizableElement: HTMLElement, handleElement: HTMLElement, {
    ...
    function resizeStart(e: MouseEvent | TouchEvent) {
        ...
        _w = parseInt(document.defaultView!.getComputedStyle(resizableElement).width, 10);
        _h = parseInt(document.defaultView!.getComputedStyle(resizableElement).height, 10);
